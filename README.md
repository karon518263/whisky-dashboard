...
1. **複製專案**：git clone https://github.com/karon518263/whisky-dashboard.git
2. **安裝套件**：pip install -r requirements.txt
3. **啟動儀表板**：streamlit run app.py

**資料來源**：[P9 品酒網](https://www.p9.com.tw/Forum/ForumSection.aspx?id=1&BoardId=5)